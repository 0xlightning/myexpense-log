                    ...
                    <div className="md:col-span-2">
                        <Card className="p-6 sticky top-8 bg-white/70 border-white/40 backdrop-blur-xl shadow-xl">
                            ...
                            <form onSubmit={handleSourceSubmit} className="space-y-4">
                                <div>
                                    <label className="block text-xs font-bold text-slate-500 mb-1.5 ml-1 uppercase tracking-widest">Source Name</label>
                            ...
                            <form onSubmit={handleItemSubmit} className="space-y-5">
                                <div className="space-y-1.5">
                                    ...
                                    <select
                                        ...
                                        className="w-full rounded-xl border border-slate-200 bg-white/50 px-4 py-3 text-slate-900 focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/10 outline-none transition-all appearance-none"
                                    >
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Deposit To</label>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            className="pl-11 bg-white/50 border-slate-200 text-slate-900 focus:border-emerald-500/50"
                                        />
                                    </div>
                                </div>
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            disabled={editingItem}
                                            className="pl-11 bg-white/80 border-slate-200 font-black text-lg text-emerald-600 focus:ring-emerald-500/20"
                                            placeholder="0.00"
                                        />
                                    </div>
                                </div>
